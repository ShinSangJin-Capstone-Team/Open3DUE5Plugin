//SDKTest.cpp: This file contains the 'main' function. The program execution will start and end here//
...
int main()
{
    ...
    Synexens::SYErrorCode errorCodeGetSDKVersion = Syn exens::GetSDKVersion(nSDKVersionLength, nullptr);
